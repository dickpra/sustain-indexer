...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        User::updateOrCreate(
            ['email' => 'admin@sustaindex.com'],
            [
                'name' => 'Super Administrator',
                'password' => Hash::make('password123'),
                'email_verified_at' => now(), // Otomatis terverifikasi biar admin bisa langsung masuk
            ]
        );

        // 2. AKUN PUBLISHER DUMP
        User::updateOrCreate(
            ['email' => 'mdpi@publisher.com'],
            [
                'name' => 'MDPI AG',
                'password' => Hash::make('password123'),
                'email_verified_at' => now(), // Otomatis terverifikasi juga buat testing cepat
            ]
        );
    }
}